  ...
  return (
    <aside className={styles.sidebar}>
      <div className={styles['sidebar-header']}>
        <div className={`${styles['sidebar-header__user']} ${styles['sidebar-user']}`}>
          <div className={styles['sidebar-user__logo']}>
            <img src={profileLogo} alt="User" className={styles['sidebar-user__logo_img']}/>
        ...
        <div className={`${styles['sidebar-header__currency']} ${styles['sidebar-currency']}`}>
          <div className={styles['sidebar-currency__amount']}>
            <img src={currencyLogo} alt="Currecy" className={styles['sidebar-currency__amount_logo']}/>
            <span className={styles['sidebar-currency__amount_value']}>{1500}</span>
          </div>
        ...
        <div className={`${styles['sidebar-header__rank']} ${styles['sidebar-rank']}`}>
          <h3 className={styles['sidebar-rank__title']}>Rank</h3>
          <img src={rankLogo} alt="Rank" className={styles['sidebar-rank__logo']}/>
        </div>
      </div>
        ...
        <ul className={styles['sidebar-navigation__list']}>
          {
            NAVIGATION_ITEMS.map((item) => (
              <li className={styles['sidebar-navigation__item']}>
                <NavLink to={item.link} className={checkIsActive}>
                  <span className={styles['sidebar-navigation__link_icon']}>{item.icon}</span>
